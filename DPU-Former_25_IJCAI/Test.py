...
parser.add_argument('--pth_path', type=str, default='./Net_epoch_best_ORS_4199.pth')
parser.add_argument('--test_dataset_path', type=str, default='')
opt = parser.parse_args()

for _data_name in ['']:
    data_path = opt.test_dataset_path+'/{}/'.format(_data_name)
    save_path = './DPU_Former/{}_3/{}/'.format(opt.pth_path.split('/')[-2], _data_name)
    os.makedirs(save_path, exist_ok=True)

    model = Network_UF_v2(channels=128)
